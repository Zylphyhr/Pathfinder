...
<template>
    <div class="col-md-8 offset-md-2 col-lg-4 offset-lg-4 col-10 offset-1 mt-3">
      ...
      <div class="row my-2 border border-white rounded">
        ...
        <select class="col-8 rounded-end darken text-white" v-model="selectedStandard" :disabled="selectedFullRound !== ''">
      ...
      <div class="row my-2 border border-white rounded">
        ...
        <select class="col-8 rounded-end darken text-white" v-model="selectedMove" :disabled="selectedFullRound !== ''">
      ...
      <div class="row my-2 border border-white rounded">
        ...
        <select class="col-8 rounded-end darken text-white" v-model="selectedSwift" :disabled="selectedFullRound !== ''">
      ...
      <div class="row my-2 border border-white rounded">
        ...
        <select class="col-8 rounded-end darken text-white" v-model="selectedFullRound"
      ...
      <div class="row my-2">
        <div class="d-flex justify-content-center mt-3">
          <button class="btn text-black border border-white bg-dark-subtle" @click="resetActions">Reset Actions</button>
        </div>
      </div>
      ...
      <div v-if="character.trackedResources.length > 0">
        ...
        <div class="card mb-3" v-for="(resource, index) in character.trackedResources" :key="`resource-${index}`">
          ...
          <div class="darken text-white card-body p-0 m-0">
            <div v-if="resource.perDay > 0" class="d-flex m-2">
            ...
            <div class="m-2" v-if="resource.showDescription">{{ resource.description }}</div>
          </div>
        </div>
      </div>
      ...
      <div class="row my-2">
        <div class="d-flex justify-content-center mt-3">
          <button class="btn text-black border border-white bg-dark-subtle" @click="resetAllResources">Reset All Resources</button>
        </div>
      </div>
...
.darken { background-color: #101C34; }
</style>